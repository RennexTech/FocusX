...
class HardcoreTimer:
    def __init__(self):
        ...
        self.is_break = False
        self.auto_start_seconds = 7
        self.prompted_sleep = False
    ...
    def setup_ui(self):
        ...
        self.btn42 = tk.Button(self.btn_frame, text='42m FOCUS\n1m REST', width=20, height=3, 
                                command=lambda: self.select_mode(42, 1),
                                bg='#2e7d32', fg='white', font=('Segoe UI', 10, 'bold'),
                                relief='raised', bd=6, activebackground='#1b5e20', cursor='hand2')
        self.btn42.pack(side='top', padx=12)
    ...
    def select_mode(self, work, rest):
        ...
        self.btn42.config(state='disabled', relief='sunken', bg='#1b5e20')
    ...
    def reset_app(self):
        ...
        self.btn42.config(state='normal', relief='raised', bg='#2e7d32')
    ...
    def check_bedtime(self):
        ...
        if now.hour == 23 and now.minute == 30 and not self.prompted_sleep:
            self.prompted_sleep = True
            response = messagebox.askyesno('Bedtime Check', 'Do you like to sleep now? If NO, system shuts down at 12.')
            if response:
    ...
    def show_blocker_overlay(self):
        ...
        funny_texts = [
            ...
            'THE COMPUTER MISSES YOU, BUT I DO NOT CARE.',
